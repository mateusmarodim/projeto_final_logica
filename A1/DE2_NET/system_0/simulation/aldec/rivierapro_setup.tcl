...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L SD_CLK -L SD_DAT -L switch_pio -L button_pio -L led_green -L led_red -L lcd_16207_0 -L timer_0 -L uart_0 -L jtag_uart_0 -L epcs_controller -L sdram_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L SD_CLK -L SD_DAT -L switch_pio -L button_pio -L led_green -L led_red -L lcd_16207_0 -L timer_0 -L uart_0 -L jtag_uart_0 -L epcs_controller -L sdram_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
