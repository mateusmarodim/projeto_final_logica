...
entity system_0_cfi_flash_0 is
	...
	port (
		...
		uas_address          : in  std_logic_vector(21 downto 0) := (others => '0'); --   uas.address
		uas_burstcount       : in  std_logic_vector(0 downto 0)  := (others => '0'); --      .burstcount
		uas_read             : in  std_logic                     := '0';             --      .read
		uas_write            : in  std_logic                     := '0';             --      .write
		uas_waitrequest      : out std_logic;                                        --      .waitrequest
		uas_readdatavalid    : out std_logic;                                        --      .readdatavalid
		uas_byteenable       : in  std_logic_vector(0 downto 0)  := (others => '0'); --      .byteenable
		uas_readdata         : out std_logic_vector(7 downto 0);                     --      .readdata
		uas_writedata        : in  std_logic_vector(7 downto 0)  := (others => '0'); --      .writedata
		...
		tcm_data_in          : in  std_logic_vector(7 downto 0)  := (others => '0')  --      .data_in
	);
end entity system_0_cfi_flash_0;

architecture rtl of system_0_cfi_flash_0 is
	component system_0_cfi_flash_0_tdt is
		port (
			clk                  : in  std_logic                     := 'X';             -- clk
			reset                : in  std_logic                     := 'X';             -- reset
			s0_uav_address       : in  std_logic_vector(21 downto 0) := (others => 'X'); -- address
			s0_uav_burstcount    : in  std_logic_vector(0 downto 0)  := (others => 'X'); -- burstcount
			...
			s0_uav_byteenable    : in  std_logic_vector(0 downto 0)  := (others => 'X'); -- byteenable
			s0_uav_readdata      : out std_logic_vector(7 downto 0);                     -- readdata
			s0_uav_writedata     : in  std_logic_vector(7 downto 0)  := (others => 'X'); -- writedata
			s0_uav_lock          : in  std_logic                     := 'X';             -- lock
			s0_uav_debugaccess   : in  std_logic                     := 'X';             -- debugaccess
			m0_uav_address       : out std_logic_vector(21 downto 0);                    -- address
			m0_uav_burstcount    : out std_logic_vector(0 downto 0);                     -- burstcount
			...
			m0_uav_byteenable    : out std_logic_vector(0 downto 0);                     -- byteenable
			m0_uav_readdata      : in  std_logic_vector(7 downto 0)  := (others => 'X'); -- readdata
			m0_uav_writedata     : out std_logic_vector(7 downto 0);                     -- writedata
	...
	end component system_0_cfi_flash_0_tdt;
	...
	component altera_merlin_slave_translator is
		...
		port (
			clk                      : in  std_logic                     := 'X';             -- clk
			reset                    : in  std_logic                     := 'X';             -- reset
			uav_address              : in  std_logic_vector(21 downto 0) := (others => 'X'); -- address
	...
	component system_0_cfi_flash_0_tda is
		port (
			clk               : in  std_logic                     := 'X';             -- clk
			reset             : in  std_logic                     := 'X';             -- reset
			...
			tcm0_address      : out std_logic_vector(21 downto 0);                    -- address_out
			tcm0_writedata    : out std_logic_vector(7 downto 0);                     -- data_out
			tcm0_data_outen   : out std_logic;                                        -- data_outen
			tcm0_readdata     : in  std_logic_vector(7 downto 0)  := (others => 'X'); -- data_in
	...
	end component system_0_cfi_flash_0_tda;
	...
	signal tdt_avalon_universal_master_0_burstcount        : std_logic_vector(0 downto 0);  -- tdt:m0_uav_burstcount -> slave_translator:uav_burstcount
	signal tdt_avalon_universal_master_0_writedata         : std_logic_vector(7 downto 0);  -- tdt:m0_uav_writedata -> slave_translator:uav_writedata
	signal tdt_avalon_universal_master_0_address           : std_logic_vector(21 downto 0); -- tdt:m0_uav_address -> slave_translator:uav_address
	...
	signal tdt_avalon_universal_master_0_readdata          : std_logic_vector(7 downto 0);  -- slave_translator:uav_readdata -> tdt:m0_uav_readdata
	signal tdt_avalon_universal_master_0_debugaccess       : std_logic;                     -- tdt:m0_uav_debugaccess -> slave_translator:uav_debugaccess
	signal tdt_avalon_universal_master_0_byteenable        : std_logic_vector(0 downto 0);  -- tdt:m0_uav_byteenable -> slave_translator:uav_byteenable
	signal tdt_avalon_universal_master_0_readdatavalid     : std_logic;                     -- slave_translator:uav_readdatavalid -> tdt:m0_uav_readdatavalid
	signal slave_translator_avalon_anti_slave_0_writedata  : std_logic_vector(7 downto 0);  -- slave_translator:av_writedata -> tda:av_writedata
	signal slave_translator_avalon_anti_slave_0_address    : std_logic_vector(21 downto 0); -- slave_translator:av_address -> tda:av_address
	...
	signal slave_translator_avalon_anti_slave_0_readdata   : std_logic_vector(7 downto 0);  -- tda:av_readdata -> slave_translator:av_readdata

begin

	tcm_address_w_check : if TCM_ADDRESS_W /= 22 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	tcm_data_w_check : if TCM_DATA_W /= 8 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	tcm_byteenable_w_check : if TCM_BYTEENABLE_W /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	tcm_read_wait_check : if TCM_READ_WAIT /= 160 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	tcm_write_wait_check : if TCM_WRITE_WAIT /= 160 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	tcm_setup_wait_check : if TCM_SETUP_WAIT /= 40 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	tcm_data_hold_check : if TCM_DATA_HOLD /= 40 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	tcm_symbols_per_word_check : if TCM_SYMBOLS_PER_WORD /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	tdt : component system_0_cfi_flash_0_tdt
		port map (
			clk                  => clk_clk,                                     --                       clk.clk
	...
	tda : component system_0_cfi_flash_0_tda
		port map (
			clk               => clk_clk,                                         --                       clk.clk
			reset             => reset_reset,                                     --                     reset.reset
...
end architecture rtl; -- of system_0_cfi_flash_0
